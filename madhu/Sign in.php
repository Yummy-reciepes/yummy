      ...
      <div class="card-body">
        <form method="post" action="Sign in.php">
          ...
          <div class="form-group">
            <input type="submit" value="Login"name="login_usr" class="btn float-right login_btn">
          </div>
        </form>
      </div>
      <div class="card-footer">
        <div style="color: inherit;color: white" class="d-flex justify-content-center links">
          <a href="sign up.php" style="width:auto;cursor:pointer;color: inherit;color: white;font-size: 18px;">Don't have an account? Sign Up</a>
        </div>
        <div class="d-flex justify-content-center">
